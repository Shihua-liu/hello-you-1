...
def blijven():
    os.system("cls")
    print("je vindt dat je genoeg heb gehad en dat je in de vluchtelingen kamp van Griekenland blijft. De eerste paar weken zaten ze je heel goed te verzorgen, maar daarna deden ze niks meer. je leven is enorm slecht geworden en het is heel moeilijk te leven. iedereen steelt van iedereen en jij hoopt dat je snel in griekenland zelf mag wonen, maar je heb na maanden niks gehoord van de regering. in de tussentijd heb je een beetje gewerkt om geld te verdienen. wat wil je doen met je geld?\n\na.door sparen\nb.gebruiken om verder te reizen.")
    ans8 = input()
    if ans8.lower() == "a":
        sparen()
    else:
...
#stuk16
def doorgaan():
    print("je denk dat het handiger is om verder te reizen naar een andere land te vluchten. je heb genoeg geld om een paar maanden te overleven. je twijvelt om naar Duitsland of naar Nederland te vluchten.\n\na.Nederland\nb.Duitsland")
    ans9 = input()
    if ans9.lower() == "a":
        nederland()
    else:
...
def linkerg():
    os.system("cls")
    print("Je kies er voor om in de linker bootje te zitten en daar in te reizen. De bestuurders komen achter dat de motor stuk is, waardoor het een langer duurt voor dat je vertrekt. Ze hadden afgesproken dat de rechter alvast begint met varen richting griekenland. 40 minuten later is de boot opgestart en zitten jullie te varen. Je hoopt dat de boot niet zal omkiepen tijdens de rit. Gelukkig waren jullie veilig aangekomen in griekenland, maar toen je om je heen zat te kijken zie de boot niet dat eerder was gaan gegaan. je heb al een gevoel wat er is gebeurt en je kiest er voor om niet door te gaan kijken. de vluchtelingen kamp geeft je de keuze om of verder te reizen of in de kampen hier te leven.\n\na.blijven\nb.door reizen\n")
    ans7 = input()
    if ans7.lower() == "a":
        os.system("cls")
        blijven()
...
def rechterg():
    os.system("cls")
    print("je heb de rechter bootje gekozen en gelukkig had het geen kapotte motor zoals de linker. Je was opgelucht dat je niet langer hoefte te wachten maar onderweg is iets erger gebeurd dan een kapotte motor. Je bootje was opeens omgekiept. Iedereen probeerde terug te zwemmen naar de boot om boven water te blijven, maar sommigen hadden dat gehaalt, maar jij niet.\n\n\n\nEINDE")
    exit()
...
#stuk11
def bootI():
    print("je betaalt je reis zonder problemen, maar onderweg kwamen er problemen aan. Er was enorme sterke wind, maar jullie hadden het grote problemen Italïe gehaald. je komt in een vluchtelingen kamp terecht en je leeft daar voor de komen de paar maanden heel erg blij. je bent later ook geaccepteerd dat je in Italïe mag wonen.\n\n\n\nEINDE")
    exit()
...
def auto():
    os.system("cls")
    print("je kiest je auto omdat je erge verhalen heb gehoord over boten en je wilt niet dood gaan. na een paar uurtjes rijden zie je stad. ga je erin om wat te kopen of rij je verder?\n\na.kopen\nb.verder rijden\n")
    ans5 = input()
    if ans5.lower() == "a":
        stad()
    else:
...
def italie():
    os.system("cls")
    print("je kiest er voor om naar Italïe te vluchten, maar je weet niet op welke manier. je hebt al eerder gehoord dat via de zee erg gevaarlijk kan zijn, maar als je met je auto gaat kan je opgepakt worden bij de grens van Syrïe.\n\nhoe wil je gaan?\na.auto\nb.boot\n")
    ans3 = input()
    if ans3.lower() == "a":
        bootI()
    else:
...
def griekenland():
    os.system("cls")
    print("je kiest er voor om naar Griekenland te vluchten, maar je weet niet op welke manier. je heb al eerder gehoord dat via de zee erg gevaarlijk kan zijn, maar als je met je auto gaat kan je opgepakt worden bij de grens van Syrïe.\n\nhoe wil je gaan?\na.auto\nb.boot\n")
    ans6 = input()
    if ans6.lower() == "a":
        auto()
    else:
...
def aanvallen():
    os.system("cls")
    print("om 6 uur 's ochtend hebben jullie besloten om het aan te vallen. De eerste paar dagen was het moeilijk omdat hun verdediging erg sterk was, maar uit eindelijk was het gelukt om de stad over te nemen. Jij en je team zaten gebouwen te checken om te kijken of alles veilig was, maar je zag een man die heel hard naar je toe zat te rennen en riep:'Allah akbar.' Je gelukkig bent heel zwaar gewond geraakt en je werd getransporteerd naar de eerste hulp. \n\n\n\n WORDT VERVOLDT")
    exit()
#stuk4
def weigeren():
...
def vechten():
    os.system("cls")
    print("Je vraagt aan je buren of zei weten hoe je snel de leger in kan.\nJe buurman gaf je advies om naar hun kamp te gaan verder op in de stad.\nJe zoekt ze op en ze accepteren je. Na een paar weken training werd je in gezet om te vechten tegen ISIS. Maanden lang zit je ISIS terug te vechten zonder veel problemen. Op een dag had je een keuze om een stad aanvallen dat onder de controle was van ISIS.\nwil je het doen\nja of nee?")
    ans_dicht = input()
